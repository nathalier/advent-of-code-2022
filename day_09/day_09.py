...
def trace_tail(moves, knots_num):
    ...
    for direction, steps in moves:
        steps_in_one_go = 1 if knots_num > 1 else steps
        for _ in range(steps // steps_in_one_go):
            knot_positions[0] = knot_positions[0] + steps_in_one_go * np.array(direction)
